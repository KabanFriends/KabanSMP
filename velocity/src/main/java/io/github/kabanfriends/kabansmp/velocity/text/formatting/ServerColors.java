...
public interface ServerColors {
    ...
    CustomColor RED_DARK = new CustomColor(170, 0, 0);
    CustomColor RED = new CustomColor(255, 0, 0);
    CustomColor RED_LIGHT = new CustomColor(255, 85, 85);
    ...
    CustomColor GOLD = new CustomColor(255, 170, 0);
    ...
    CustomColor YELLOW = new CustomColor(255, 255, 85);
    ...
    CustomColor GREEN_DARK_2 = new CustomColor(0, 170, 0);
    CustomColor GREEN_DARK = new CustomColor(42, 212, 42);
    CustomColor GREEN = new CustomColor(85, 255, 85);
    ...
    CustomColor AQUA_DARK = new CustomColor(0, 170, 170);
    CustomColor AQUA = new CustomColor(42, 212, 212);
    CustomColor AQUA_LIGHT = new CustomColor(85, 255, 255);
    ...
    CustomColor BLUE_DARK_2 = new CustomColor(0, 0, 170);
    CustomColor BLUE_DARK = new CustomColor(85, 0, 255);
    CustomColor BLUE = new CustomColor(85, 85, 255);
    ...
    CustomColor MAGENTA_DARK = new CustomColor(170, 0, 170);
    CustomColor MAGENTA = new CustomColor(212, 42, 212);
    CustomColor MAGENTA_LIGHT = new CustomColor(255, 85, 255);
    ...
    CustomColor GRAY_DARK = new CustomColor(85, 85, 85);
    CustomColor GRAY = new CustomColor(128, 128, 128);
    CustomColor GRAY_LIGHT = new CustomColor(170, 170, 170);
